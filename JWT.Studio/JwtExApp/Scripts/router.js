angular.module('app').config(['$stateProvider', '$urlRouterProvider', function (stateprovider, routeProvider) {
	...
	stateprovider.state('layout1.nav1',{url:'/nav1',views:{'col1':{templateUrl:'Templates/Widgets/widget1.html',controller:'widget1Ctrl'},'col2':{templateUrl:'Templates/Widgets/widget1.html',controller:'widget1Ctrl'}}});
	stateprovider.state('layout2.nav2',{url:'/nav2',templateUrl:'Templates/Widgets/widget2.html',controller:'widget2Ctrl'});
}]);
