        ...
        public void CreateItem(string mode, string name)
        {
            ...
            lock (locker)
            {
                ...
                if (!file.DirectoryExists(Root + "Scripts\\Base"))
                {
                    ...
                    InstallTplFile(file, "app.txt", Root + "Scripts\\app.js");
                    InstallTplFile(file, "appStarter.txt", Root + "Scripts\\appStarter.js");
                    InstallTplFile(file, "BaseCtrl.txt", Root + "Scripts\\Base\\BaseCtrl.js");
                    InstallTplFile(file, "BaseSvc.txt", Root + "Scripts\\Base\\BaseSvc.js");
                    ...
                    InstallTplFile(file, "filters.txt", Root + "Scripts\\app.filters.js");
                    file.CreateDirectory(Root + "Scripts\\Layouts");
