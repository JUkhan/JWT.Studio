...
(function (window) {
    ...
    var BaseController = jsClass.extend({
        ...
        init: function (scope, service, sce) {
            ...
            this.scope.gridAction = {
                EditAction: function (row) {
                    this.scope.model = this.OnPreLoadForm(row.entity);
        ...
        Insert: function (data) {
            ...
            this.service.Insert(data).then(function (p) {
                var res = p;
        ...
        Update: function (data) {
            ...
            this.service.Update(data).then(function (p) {
                var res = p;
                this.scope.message = res.Message;
        ...
        Delete: function (data) {
            ...
            this.service.Delete(data).then(function (p) {
        ...
        GetAll: function () {
            ...
            this.service.GetAll().then(function (p) {
                var res = p;
        ...
        GetPaged: function () {
            ...
            this.service.GetPaged(this.pageNo, this.pageSize).then(function (p) {
                var res = p;
        ...
        GetPagedWhile: function (data) {
            ...
            this.service.GetPagedWhile(this.pageNo, this.pageSize, data).then(function (p) {
                var res = p;
                this.scope.gridOpts.totalItems = res.TotalRow;
