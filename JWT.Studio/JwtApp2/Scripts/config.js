...
stateprovider.state('layout1.max',{url:'/max',views:{'col1':{controller:'nav1Ctrl as vm', templateUrl:root + 'Templates/Components/nav1.html'},'col2':{controller:'nav2Ctrl as vm', templateUrl:root + 'Templates/Components/nav2.html'}}});
